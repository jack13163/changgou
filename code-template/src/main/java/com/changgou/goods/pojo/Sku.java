...
public class Sku implements Serializable{
	...
	private Date categoryName;//类目名称

	@ApiModelProperty(value = "品牌名称",required = false)
    @Column(name = "brand_name")
	private Date brandName;//品牌名称
	...
	//get方法
	public Date getBrandName() {
		return brandName;
	}

	//set方法
	public void setBrandName(Date brandName) {
	...
	//get方法
	public Date getCommentNum() {
		return commentNum;
	}

	//set方法
	public void setCommentNum(Date commentNum) {
