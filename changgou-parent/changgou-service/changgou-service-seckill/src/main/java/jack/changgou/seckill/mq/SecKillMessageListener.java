package jack.changgou.seckill.mq;
...
public class SecKillMessageListener {
    ...
    public void handler(String message) {
        ...
        System.out.println(simpleDateFormat.format(new Date()) + ": 监听到支付订单[" + message + "]");
        ...
        if (map != null) {
            if (map.get("return_code") != null && map.get("return_code").equals("SUCCESS")) {
                ...
                String username = (String) attachMap.get("username");
                ...
                if (map.get("result_code") != null && map.get("result_code").equals("SUCCESS")) {
                    ...
                    seckillOrderService.updateStatus(username, payTime, transactionId);
                } else {
